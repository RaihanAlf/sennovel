                                    ...
                                    <ul>
                                        ...
                                        <li class="dropdown"><a href="#" style="color: #000000;">Fan Fiction <i class="bi bi-chevron-down" style="color: #000000;"></i></a>
                                            <ul>
                                                ...
                                                ?>
                                                <li><a href="<?php echo site_url(); ?>" style="color: #000000;"><?= $data['judul'];?></a></li>                                            
                                                <?php } ?>
                                            </ul>
                                        </li>
                                        ...
                                        <li>
                                            <a href="#" style="color: #000000;">Action</a>
                                        </li>
                                    </ul>
                                </li> -->
                                <li>
                                    <a href="#" style="color: #000000;">About Me</a>
                                </li>
                            </ul>
                                                            ...
                                                            <div class="summary_content">
                                                                ...
                                                                <div class="post-status">
                                                                    ...
                                                                    <div id="init-links" class="nav-links" style="text-align:center;">
                                                                        <!-- <a href="#" id="btn-read-last" class="c-btn c-btn_style-1"><?= $data[0]["judul_chapters"];?></a>
                                                                            ...
                                                                            foreach($data as $key => $val) {
                                                                                echo '
                                                                                    <li class="wp-manga-chapter">
                                                                                        <a href="'.site_url('welcome/read/').$val["id_chapter"].'" style="width:100%;">'.$val["judul_chapters"].'
