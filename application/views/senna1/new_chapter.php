            ...
            ***********************************-->
            <div class="content-body">
                ...
                <div class="container-fluid">
                    <form action="<?= base_url('senna/post/new_chapter') ?>" method="post">
                        <input type="hidden" name="book" value="<?= $data->judul ?>">
                        <section id="writer-editor-container" style="background-color: #fff; display: block;">
                            <div id="writer-editor" style="max-width: 900px; width: auto; margin: 0 auto; padding: 48px 90px; color: #222; background-color: #fff;">
                                <!-- <h2 id="story-title" name="judul_chapters" contenteditable="true" style="margin-top: 0; text-align: center; border-bottom: 1px solid #eee; padding-bottom: 12px; font-size: 32px; font-weight: 400; line-height: 36px; margin-bottom: 12px; -webkit-user-modify: read-write; overflow-wrap: break-word; -webkit-line-break: after-white-space; display: block; margin-block-start: 0.83em; margin-block-end: 0.83em; margin-inline-start: 0px; margin-inline-end: 0px;">Judul Chapter</h2> -->
                                <input type="text" name="judul_chapters" value="Judul Chapter" style="border: none; margin-top: 0; text-align: center; border-bottom: 1px solid #eee; padding-bottom: 12px; font-size: 32px; font-weight: 400; line-height: 36px; margin-bottom: 12px; margin-left: 167px;">
                                <textarea id="content" name="isi" placeholder="Tulis isi cerita" rows="12"></textarea>                             
                                <div class="row" style="margin-left: 1px; margin-top: 10px; float:right;">
                                    <!-- <div class="text-center" style="margin-bottom: 10px;"><button class="btn btn-secondary" type="submit">Save Draf</button></div> -->
                                    <div class="text-center" style="margin-bottom: 10px; margin-right: 15px;"><button class="btn btn-secondary" type="submit"><i class="fa fa-upload color-success"></i> Publish</button></div>
                                </div>  
                            </div>
                        </section>
                    </form>
