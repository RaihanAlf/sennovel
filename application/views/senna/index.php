...
<html lang="en">
    ...
    <body>  
        ...
        <header id="header" class="fixed-top d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="<?php echo site_url('senna/dashboard'); ?>"><span>Sen</span>Novel</a></h1>
            <!-- Uncomment below if you prefer to use an image logo -->
            <!-- <a href="index.html" class="logo me-auto"><img src="assets/img/logo.png" alt=""></a>-->

            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    <li><a class="nav-link scrollto active" href="<?php echo site_url('senna/dashboard'); ?>">Home</a></li>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    ...
                    <div class="member-info">
                        ...
                        <a href="<?php echo site_url('senna/dashboard/detail/'.$book['id']); ?>" class="btn btn-danger" style="float: right; margin-bottom: 10px;">Learn More <i class="bi bi-arrow-right"></i></a>
                    </div>
                    </div>
                </div>
                <?php } ?>
